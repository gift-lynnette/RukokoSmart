...
-- NOTE: Do not insert a plain-text password here.
-- Run create_admin.php once (see below) to generate the first admin account
-- with a properly hashed password, then delete create_admin.php from the server.
